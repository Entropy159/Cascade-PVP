...
public class ServerConfig {
    ...
    public static final ModConfigSpec.DoubleValue SHADOW_KARAMBIT_WITHER_CHANCE = BUILDER.comment("The chance to inflict wither on hit entities (0-1), is multiplied by the damage").defineInRange("shadowKarambit.witherChance", 0.1, 0, 1);
    public static final ModConfigSpec.IntValue SHADOW_KARAMBIT_WITHER_DURATION = BUILDER.comment("The duration of the wither effect in ticks, is multiplied by the damage").defineInRange("shadowKarambit.witherDuration", 25 * 20, 0, 20000);
