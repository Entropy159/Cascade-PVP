...
public class ServerConfig {
    ...
    public static final ModConfigSpec.ConfigValue<Float> BOW_OF_THE_GALADHRIM_VELOCITY = BUILDER.comment("The velocity multiplier of arrows shot").define("bowOfTheGaladhrim.velocity", 2f);
    public static final ModConfigSpec.ConfigValue<Float> BOW_OF_THE_GALADHRIM_ACCURACY = BUILDER.comment("The inaccuracy of the bow is divided by this amount. Set to zero for perfect accuracy").define("bowOfTheGaladhrim.accuracy", 2f);
    ...
    public static final ModConfigSpec.ConfigValue<Float> BOOMBOW_EXPLOSION_RADIUS = BUILDER.comment("The explosion radius of shot arrows. TNT is 4, crystal is 6").define("boombow.explosionRadius", 2f);
